...
public final class HeartbeatServiceGrpc {
  ...
  public static final String SERVICE_NAME = "pt.ulisboa.tecnico.contract.HeartbeatService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<pt.ulisboa.tecnico.contract.HeartbeatServiceOuterClass.HeartbeatRequest,
      pt.ulisboa.tecnico.contract.HeartbeatServiceOuterClass.HeartbeatResponse> getHeartbeatMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "heartbeat",
      requestType = pt.ulisboa.tecnico.contract.HeartbeatServiceOuterClass.HeartbeatRequest.class,
      responseType = pt.ulisboa.tecnico.contract.HeartbeatServiceOuterClass.HeartbeatResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<pt.ulisboa.tecnico.contract.HeartbeatServiceOuterClass.HeartbeatRequest,
      pt.ulisboa.tecnico.contract.HeartbeatServiceOuterClass.HeartbeatResponse> getHeartbeatMethod() {
    io.grpc.MethodDescriptor<pt.ulisboa.tecnico.contract.HeartbeatServiceOuterClass.HeartbeatRequest, pt.ulisboa.tecnico.contract.HeartbeatServiceOuterClass.HeartbeatResponse> getHeartbeatMethod;
      ...
      synchronized (HeartbeatServiceGrpc.class) {
        if ((getHeartbeatMethod = HeartbeatServiceGrpc.getHeartbeatMethod) == null) {
          HeartbeatServiceGrpc.getHeartbeatMethod = getHeartbeatMethod =
              io.grpc.MethodDescriptor.<pt.ulisboa.tecnico.contract.HeartbeatServiceOuterClass.HeartbeatRequest, pt.ulisboa.tecnico.contract.HeartbeatServiceOuterClass.HeartbeatResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "heartbeat"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  pt.ulisboa.tecnico.contract.HeartbeatServiceOuterClass.HeartbeatRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  pt.ulisboa.tecnico.contract.HeartbeatServiceOuterClass.HeartbeatResponse.getDefaultInstance()))
  ...
  public static abstract class HeartbeatServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void heartbeat(pt.ulisboa.tecnico.contract.HeartbeatServiceOuterClass.HeartbeatRequest request,
        io.grpc.stub.StreamObserver<pt.ulisboa.tecnico.contract.HeartbeatServiceOuterClass.HeartbeatResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                pt.ulisboa.tecnico.contract.HeartbeatServiceOuterClass.HeartbeatRequest,
                pt.ulisboa.tecnico.contract.HeartbeatServiceOuterClass.HeartbeatResponse>(
  ...
  public static final class HeartbeatServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<HeartbeatServiceBlockingStub> {
    ...
    /**
     */
    public pt.ulisboa.tecnico.contract.HeartbeatServiceOuterClass.HeartbeatResponse heartbeat(pt.ulisboa.tecnico.contract.HeartbeatServiceOuterClass.HeartbeatRequest request) {
  ...
  public static final class HeartbeatServiceFutureStub extends io.grpc.stub.AbstractFutureStub<HeartbeatServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<pt.ulisboa.tecnico.contract.HeartbeatServiceOuterClass.HeartbeatResponse> heartbeat(
        pt.ulisboa.tecnico.contract.HeartbeatServiceOuterClass.HeartbeatRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_HEARTBEAT:
          serviceImpl.heartbeat((pt.ulisboa.tecnico.contract.HeartbeatServiceOuterClass.HeartbeatRequest) request,
              (io.grpc.stub.StreamObserver<pt.ulisboa.tecnico.contract.HeartbeatServiceOuterClass.HeartbeatResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class HeartbeatServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return pt.ulisboa.tecnico.contract.HeartbeatServiceOuterClass.getDescriptor();
    }
